...
static u16_t SSI_Handler(int iIndex, char *pcInsert, int iInsertLen)
{
    switch(iIndex)
    {
        case 0:
          adc0++;
            return snprintf(pcInsert, iInsertLen, "%d", adc0);
            

        case 1:
            return snprintf(pcInsert, iInsertLen, "%d", 124);

        case 2:
            return snprintf(pcInsert, iInsertLen, "%d", 125);

        case 3:
            return snprintf(pcInsert, iInsertLen, "%s", "salam");
    }
    return 0;
}
