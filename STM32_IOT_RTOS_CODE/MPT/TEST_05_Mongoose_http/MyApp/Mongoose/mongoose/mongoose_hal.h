...
#define LED_3 PIN('B', 14)  // On-board LED pin (red)
...
static inline void hal_leds_init(void) {
  hal_gpio_output(LED_1);              // Initialise LED1
  hal_gpio_output(LED_2);              // Initialise LED2
  hal_gpio_output(LED_3);              // Initialise LED3
}
