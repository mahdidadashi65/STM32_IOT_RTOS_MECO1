...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, NRF_CE_Pin|WIZ_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : NRF_CE_Pin NRF_CSN_Pin WIZ_CS_Pin */
  GPIO_InitStruct.Pin = NRF_CE_Pin|NRF_CSN_Pin|WIZ_CS_Pin;
