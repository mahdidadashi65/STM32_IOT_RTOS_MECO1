...
void ST7789_Test(void)
{
	...
	ST7789_WriteString(10, 50, "Hello Mahdi!", Font_7x10, RED, WHITE);
	ST7789_WriteString(10, 75, "Hello Mahdi!", Font_11x18, YELLOW, WHITE);
	ST7789_WriteString(10, 100, "Hello Mahdi!", Font_16x26, MAGENTA, WHITE);
	HAL_Delay(1000);
