...
#define LED_LAN_Pin GPIO_PIN_6
#define LED_LAN_GPIO_Port GPIOE
#define LED_BUS2_Pin GPIO_PIN_6
#define LED_BUS2_GPIO_Port GPIOC
#define LED_BUS1_Pin GPIO_PIN_7
#define LED_BUS1_GPIO_Port GPIOC
