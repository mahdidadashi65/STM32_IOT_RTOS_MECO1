...
struct attribute s_state_attributes[] = {
  {"voltage01", "int", NULL, offsetof(struct state, voltage01), 0, false},
  {"current01", "int", NULL, offsetof(struct state, current01), 0, false},
  {"temperature02", "int", NULL, offsetof(struct state, temperature02), 0, false},
  {"speed", "int", NULL, offsetof(struct state, speed), 0, false},
  {"temperature01", "int", NULL, offsetof(struct state, temperature01), 0, false},
  ...
  {"soc0", "int", NULL, offsetof(struct state, soc0), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_leds_attributes[] = {
  {"led4", "bool", NULL, offsetof(struct leds, led4), 0, false},
...
struct attribute s_network_settings_attributes[] = {
  {"name", "string", NULL, offsetof(struct network_settings, name), 20, false},
...
struct attribute s_pwms_attributes[] = {
  {"pwm4", "int", NULL, offsetof(struct pwms, pwm4), 0, false},
  {"pwm1", "int", NULL, offsetof(struct pwms, pwm1), 0, false},
  {"pwm2", "int", NULL, offsetof(struct pwms, pwm2), 0, false},
  {"pwm3", "int", NULL, offsetof(struct pwms, pwm3), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_vals_attributes[] = {
  {"val4", "double", NULL, offsetof(struct vals, val4), 0, false},
  {"val3", "double", NULL, offsetof(struct vals, val3), 0, false},
  {"val2", "double", NULL, offsetof(struct vals, val2), 0, false},
  {"val1", "double", NULL, offsetof(struct vals, val1), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_settings_attributes[] = {
  {"client_mac", "string", NULL, offsetof(struct settings, client_mac), 40, false},
  {"is_client", "bool", NULL, offsetof(struct settings, is_client), 0, false},
  {"server_mac", "string", NULL, offsetof(struct settings, server_mac), 40, false},
  ...
  {"is_server", "bool", NULL, offsetof(struct settings, is_server), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_digitals_attributes[] = {
  {"in4", "bool", NULL, offsetof(struct digitals, in4), 0, false},
  {"in3", "bool", NULL, offsetof(struct digitals, in3), 0, false},
  {"in2", "bool", NULL, offsetof(struct digitals, in2), 0, false},
  {"in1", "bool", NULL, offsetof(struct digitals, in1), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
...
struct apihandler_data s_apihandler_pwms = {{"pwms", "data", false, 0, 0, 0UL}, s_pwms_attributes, sizeof(struct pwms), (void (*)(void *)) glue_get_pwms, (void (*)(void *)) glue_set_pwms};
struct apihandler_data s_apihandler_vals = {{"vals", "data", false, 0, 0, 0UL}, s_vals_attributes, sizeof(struct vals), (void (*)(void *)) glue_get_vals, (void (*)(void *)) glue_set_vals};
...
struct apihandler_data s_apihandler_digitals = {{"digitals", "data", false, 0, 0, 0UL}, s_digitals_attributes, sizeof(struct digitals), (void (*)(void *)) glue_get_digitals, (void (*)(void *)) glue_set_digitals};
...
static struct apihandler *s_apihandlers[] = {
  ...
  (struct apihandler *) &s_apihandler_pwms,
  (struct apihandler *) &s_apihandler_vals,
  (struct apihandler *) &s_apihandler_settings,
  (struct apihandler *) &s_apihandler_digitals
};
